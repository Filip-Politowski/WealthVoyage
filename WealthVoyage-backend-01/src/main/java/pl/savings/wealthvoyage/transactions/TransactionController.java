...
public class TransactionController {
    ...
    @GetMapping("/incomes/last/six/months/{transactionType}")
    public List<AmountSumWithMonth> getSixMonthSums(@AuthenticationPrincipal UserDetails userDetails, @PathVariable TransactionType transactionType) {
        return transactionService.getSumOfLastSixMonthsIncomeOrExpense(userDetails, transactionType);
    }
